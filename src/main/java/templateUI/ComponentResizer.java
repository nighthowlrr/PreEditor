...
public class ComponentResizer extends MouseAdapter {
    ...
    /**
     *  Convenience constructor. All borders are resizable in increments of a single pixel. Components must
    ...
    /**
     *  Convenience constructor. All borders are resizable in increments of a single pixel. Components can
     *  be registered when the class is created, or they can be registered separately afterward.
     *
    ...
    /**
     *  Convenience constructor. Eligible borders are resizable in increments of a single pixel. Components
     *  can be registered when the class is created, or they can be registered separately afterward.
     *
    ...
    /**
     *  Set the drag dragInsets. The insets specify an area where mouseDragged events are recognized from
     *  the edge of the border inwards. A value of 0 for any size will imply that the border is not
     *  resizable. Otherwise, the appropriate drag cursor will appear when the mouse is inside the
    ...
    /**
     *  Specify the maximum size for the component. The component will still be constrained by the size of
     *  its parent.
     *
    ...
    /**
     *  Control how many pixels a border must be dragged before the size of the component is changed. The
     *  border will snap to the size once dragging has passed the halfway mark.
     *
     *  @param snapSize Dimension object allows you to separately specify a horizontal and vertical snap size.
     */
    ...
    /**
     *  When the component's minimum size is less than the drag insets, then we can't determine which border
     *  should be resized, so we need to prevent this from happening.
     */
    @Contract(pure = true)
    ...
    public void mousePressed(MouseEvent e) {
        ...
        //  Setup for resizing. All future dragging calculations are done based on the original bounds of the
        //  component and mouse pressed location.
        resizing = true;
    ...
    /**
     *  Resize the component ensuring location and size is within the bounds of the parent container and that
     *  the size is within the minimum and maximum constraints.
    ...
    protected void changeBounds(Component source, int direction, @NotNull Rectangle bounds, Point pressed, Point current) {
        ...
        source.getParent().repaint(); // TODO: IMPORTANT !!! CLEANUP
    }
