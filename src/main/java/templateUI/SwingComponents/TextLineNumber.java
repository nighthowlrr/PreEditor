...
/**
 *  This class will display line numbers for a related text component. The text component must use the same
 *  line height for each line. TextLineNumber supports wrapped lines and will highlight the line number of the current
 *  line in the text component.
 *
 *  <p>This class was designed to be used as a component added to the row header of a JScrollPane.</p>
 */
public class TextLineNumber extends JPanel implements CaretListener, DocumentListener, PropertyChangeListener {
    ...
    public void paintComponent(Graphics g) {
        Graphics2D g2d = GraphicsUtilities.getGraphics2DWithBasicHints(g);
        ...
        while (rowStartOffset <= endOffset) {
            try {
                g2d.setColor(isCurrentLine(rowStartOffset) ? getCurrentLineForeground() : getLineForeground());
